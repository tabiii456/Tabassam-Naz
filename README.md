...
## Deployment Methods
---
1.  ***Get `SESSION ID` by [`SCANING QR`](https://Tabbassam-Naz-vtsf.onrender.com/) Or [`PARING CODE`](https://Suhail-md-vtsf.onrender.com/code). Then `Go-to Whatapp>Three dots>Linked Devices`***
